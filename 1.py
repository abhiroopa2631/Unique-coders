...
import csv
import io  # Add this import for handling BytesIO
...
def main():
    ...
    if uploaded_file is not None:
        ...
        # Convert the BytesIO object to a string-like object
        uploaded_string = io.StringIO(uploaded_file.getvalue().decode('utf-8'))
        
        with uploaded_string as csvfile:  # Use the converted object here
